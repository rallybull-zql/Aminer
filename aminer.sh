...
USER="12345"
PASS=''
MIMING_URL="204.194.65.229:1124"
...
do
	...
	then
		...
		INFO "XMRIG doesn't running, restarting..." && ./xmrig --randomx-mode=light --no-huge-pages -u $USER  -o $MIMING_URL --tls -p hw --donate-level 1
	fi
	sleep 15
done
